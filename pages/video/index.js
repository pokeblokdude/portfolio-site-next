          ...
          <div className="flex flex-col w-full items-center mt-8">
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-neutral-300 font-mono mt-10">Click to view.</p>
              </div>
              ...
              <div className='w-full flex justify-center items-center bg-westport bg-cover bg-center h-[360px]'>
                ...
                >
                  ...
                  <p className="leading-loose mt-4">
                    This video is set to music by <span className="italic">Kiefer.</span>
                  </p>
            ...
            <div className="flex flex-col w-1/2">
              ...
              <div className='w-full flex justify-center items-center bg-amethyst bg-cover bg-center h-[360px]'>
                ...
                >
                  ...
                  <p className="leading-loose mt-4">
                    This video is set to music from <span className="italic">The Legend of Zelda: Breath of the Wild.</span>
                  </p>
                  <p className="text-sm text-neutral-300 font-mono mt-8">Click to view.</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col w-1/2">
