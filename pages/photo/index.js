  ...
  return (
    <>
      ...
      <div className="w-[1160px] flex flex-col mb-20 items-center mobile:w-[360px]">
        ...
        <h1 className="text-2xl font-semibold w-[95%] self-center mt-10">Photos</h1>
        <h2 className='w-[95%] text-neutral-200'>See full-quality versions on&nbsp;
        ...
        <h3 className='w-[95%] mb-4 mt-2 text-sm text-neutral-400'>This page may take a few seconds to load.</h3>
        ...
        <div className='flex w-full justify-between items-center mobile:flex-col'>
          <div className="flex w-[339px] h-[520px] relative mobile:w-full mobile:h-[544px]">
            <Image src='/photo/pr-street.jpg' layout='fill' className='object-contain' loading='eager' alt=''/>
          </div>
          <div className="flex w-[810px] h-[520px] relative items-center mobile:w-full mobile:h-[226px]">
        ...
        <div className='flex w-full justify-between items-center'>
          <div className="flex w-full h-[780px] relative mobile:h-[244px]">
            <Image src='/photo/towel.jpg' layout='fill' className='object-contain' alt='' loading='eager' quality={100}/>
          </div>
        </div>
        <div className='flex w-full justify-between items-center mobile:flex-col'>
          <div className="flex w-[575px] h-[398px] relative items-center mobile:w-full mobile:h-[242px]">
            <Image src='/photo/janna-cliff.jpg' layout='fill' className='object-contain' loading='eager' alt=''/>
          </div>
          <div className="flex w-[575px] h-[398px] relative mobile:w-full mobile:h-[244px]">
            <Image src='/photo/niagara-2.jpg' layout='fill' className='object-contain' loading='eager' alt=''/>
          </div>
        </div>
        <div className='flex w-full justify-between items-center'>
          <div className="flex w-full h-[780px] relative mobile:h-[242px]">
        ...
        <div className='flex w-full justify-between items-center mobile:flex-col'>
          <div className="flex w-[750px] h-[510px] relative items-center mobile:w-full mobile:h-[245px]">
            <Image src='/photo/stars.jpg' layout='fill' className='object-contain' alt='' loading='eager' quality={100}/>
          </div>
          <div className="flex w-[400px] h-[450px] relative">
        ...
        <div className='flex w-full justify-between items-center'>
          <div className="flex w-full h-[786px] relative mobile:h-[240px]">
            <Image src='/photo/janna.jpg' layout='fill' className='object-contain' alt='' loading='eager' quality={100}/>
          </div>
        </div>
        <div className='flex w-full justify-between items-center'>
          <div className="flex w-full h-[780px] relative mobile:h-[246px]">
